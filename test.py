...
class CustomInteractorStyle(vtk.vtkInteractorStyleImage):
    ...
    def change_orientation(self):
        # This method can be called to change the orientation of the viewer
        current_orientation = self.image_viewer.GetSliceOrientation()
        new_orientation = (current_orientation + 1) % 3
        self.image_viewer.SetSliceOrientation(new_orientation)
    ...
    def key_press_event(self, obj, event):
        ...
        elif key == "o":  # Example: Press 'o' to change orientation
            # Define new orientation (this is just an example, you can define it as needed)
...
class DICOMViewer:
    ...
    def setup_text_labels(self):
        self.slice_text_actor = self.create_text_actor(
            "", 15, 10, 20, align_bottom=True
        )
    ...
    def configure_interactor(self):
        ...
        self.interactor_style = CustomInteractorStyle(
            self.image_viewer, self.slice_text_actor
        )
        self.image_viewer.SetupInteractor(self.interactor)
        self.interactor.SetInteractorStyle(self.interactor_style)

    def create_text_actor(
        self, text, x, y, font_size, align_bottom=False, normalized=False
    ):
        ...
        (
            ...
            if align_bottom
            else text_prop.SetVerticalJustificationToTop()
        )
...
if __name__ == "__main__":
    ...
    dicom_folder_path = r"D:\dicom_normalized_out\CANON-Aquilion_64-1-114.3-12.4-NA-AIDR_3D_STD-FC13\ensemble"

    # Create an instance of DICOMViewer with the DICOM folder path
    viewer = DICOMViewer(dicom_folder=dicom_folder_path)
